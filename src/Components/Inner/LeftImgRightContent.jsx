...
const LeftImgRightContent = () => {
  return (
    <div className="container px-4 lg:px-9  lg:h-[480px]  py-5 text-white flex flex-wrap lg:flex-nowrap justify-center items-center lg:justify-around  mx-auto max-w-[1300px] w-full">
      <div className="max-w-[600px] py-10 w-full">
